...
def _build_html_header(file_path, version, audit_id=None):
    ...
    header_lines.append(f"<h1 style='margin: 0 0 5px 0;'>OAS Audit Report</h1>")
    header_lines.append(
        f"<p style='margin: 0; color: #bdc3c7; font-size: 0.85em;'><a href='https://tylercbrock.com' style='color: inherit; text-decoration: none;'>TB's Auditor v{version}</a></p>"
    )
